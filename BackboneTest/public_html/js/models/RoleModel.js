...
define([
  ...
  var RoleModel = Backbone.Model.extend({
        urlRoot: "http://localhost:8080/practica/webresources/edu.poli.prap.pp.data.role/",
        idAttribute: 'idrole',
        defaults: {
            name: ""
        },
        ...
        sync: function (method, model, options) {
            ...
            if (method == 'create') {
                options.url = 'http://localhost:8080/practica/webresources/edu.poli.prap.pp.data.role/';
            }
