...
define([
  ...
  'backbone'
    ...
    var LevelModel = Backbone.Model.extend({
        urlRoot: "http://localhost:8080/practica/webresources/edu.poli.prap.pp.data.level/",
        idAttribute: 'idlevel',
        defaults: {
            name: "",
            points: ""
        ...
        sync: function (method, model, options) {
            ...
            if (method == 'create') {
                options.url = 'http://localhost:8080/practica/webresources/edu.poli.prap.pp.data.level/';
            }
